-- Final metadata function that handles bot protection and various scenarios
...
-- Success message
SELECT 'Final metadata function installed successfully! Ready to handle bot protection and extract titles.' as message; 